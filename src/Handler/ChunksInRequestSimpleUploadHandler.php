 ...
 */
class ChunksInRequestSimpleUploadHandler extends AbstractHandler
{
    /**
    ...
    {
        return $request->has('chunkNumber') && $request->has('totalChunks');
    }
    ...
    protected function getCurrentChunkFromRequest(Request $request)
    {
        ...
        return intval($request->get('chunkNumber')) + 1;
    }
    ...
    {
        return intval($request->get("totalChunks"));
    }
